...
class GoalController extends Controller
{
    ...
    public function store(Request $request)
    {
        $validated = $request->validate([
            ...
            'auto_topup_percent' => 'nullable|numeric|min:0|max:100',
        ]);
        ...
        $goal = Goal::create([
            ...
            'auto_topup_percent' => (float) ($validated['auto_topup_percent'] ?? 0),
        ]);
    ...
    public function update(Request $request, string $id)
    {
        ...
        if (array_key_exists('auto_topup_percent', $validated)) {
            $validated['auto_topup_percent'] = (float) $validated['auto_topup_percent'];
        }
